...
DRAIN_REASON_ENTRY_AUTO_DRAIN = "entry_auto_drain"

PLACEMENT_RECONCILER_IDLE_WHEN_DISABLED_SEC = 60

NATS_HEALTH_MEM_WARN_BYTES = 700 * 1024 * 1024
NATS_HEALTH_SLOW_CONSUMERS_WARN = 50
